...
function Residents() {
    ...
    useEffect(() => {
        ...
        if (tx) setMessage(`Transaction sent: ${tx}`);
                                ...
                                <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                        <h6 className="text-white text-capitalize ps-3">
                                            <i className="material-icons opacity-10 me-2">group</i>Residents</h6>
                                    </div>
                                </div>
                                <div className="card-body px-0 pb-2">
                                    {
                                        message && <Alert title="Success!" text={message} alertClass="alert-success" materialIcon="thumb_up_off_alt" />
                                    }
                                    {
                                        error && <Alert title="Error!" text={error} alertClass="alert-danger" materialIcon="error" />
                                    }
                                    ...
                                    <div className="row ms-2">
                                        <div className="col-md-12 mb-3">
                                            <a className="btn bg-gradient-dark me-2" href="/residents/new">
                                                <i className="material-icons opacity-10 me-2">add</i> Add New Resident
                                            </a>
                                        </div>
                                    </div>
                                </div>
